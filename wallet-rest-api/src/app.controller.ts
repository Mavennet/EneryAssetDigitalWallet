...
export class AppController {
  ...
  async getTransferTokenEvents() {
    return this.appService.getTransferTokenEvents();
  }

  @Get('schema-registered')
  async getTransferFromTokenEvents() {
    return this.appService.getTransferFromTokenEvents();
  }

  @Get('nym-registered')
  async getRetireTokenEvents() {
    return this.appService.getRetireTokenEvents();
  }

  @Get('interactions')
  @ApiOperation({ summary: 'Retrieve all Interactions with Emission Smart Contract' })
